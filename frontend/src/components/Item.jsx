...
duration-700'><FaSearch className=' scale-125 hover:rotate-90 hover:scale-125 transition-all
duration-200'/></Link>
...
<h4 className='my-[6px] medium-16 line-clamp-2text-gray-30'>{name}</h4>
<div className='flex gap-5'>
<div className='bold-16'>{new_price}.00</div>
<div className='text-red-600 bold-16 line-through'>{old_price}.00</div>
</div>
</div>
</div>
)
