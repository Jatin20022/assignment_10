...
border-slate-900/20text-gray-30 p-6 medium-14
text-center'>
<td className='flexCenter'><img src={e.image}
alt="prdctImg" height={43} width={43}
className='rounded-1g ring-1 ☐ ring-slate-900/5 my-1' /></td>
<td><div className='line-clamp-3'>{e.name}</div></td>
<td>$(e.new_price)</td>
<td className='w-162h-16 bg-white'>{cartItems[e.id]}
</td>
<td>${e.new_price * cartItems[e.id]}</td>
<td>
<div className='bold-22 p1-14'><TbTrash onClick=
{()=> removeFromCart(e.id)}/></div>
</td>
</tr>
}
return null;
...
<div className='flexBetween pl-5 h-12bg-primary
